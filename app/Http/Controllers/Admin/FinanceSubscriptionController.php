...
class FinanceSubscriptionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->rawColumns(['actions', 'custom-status', 'created-on', 'custom-plan-type'])
                    ->make(true);
    ...
    public function store()
    {
        ...
        $frequency = (request('plan-type') == 'subscription') ? 'Monthly Payment' : 'One Time Payment';
    ...
    {
        request()->validate([
            'paypal_gateway_plan_id' => 'required',
            'stripe_gateway_plan_id' => 'required',
            'plan-type' => 'required',
            'plan-status' => 'required',
            'plan-name' => 'required',
            'cost' => 'required|integer',
