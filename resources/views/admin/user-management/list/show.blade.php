					...
					<div class="row">
						<div class="col-sm-6 border-right border-bottom text-center">
							<div class="p-2">
								...
								<h5 class="mt-1 mb-1 font-weight-bold text-dark number-font fs-14">${{ $user->balance }}</h5>								
							</div>
						</div>
						...
						<div class="card-body">
							<div class="row mb-5 mt-2">	
								<div class="col-xl-4 col-12 ">
									<p class=" mb-1 fs-12">{{ __('Total Payments') }} (USD)</p>
									<h3 class="mb-0 fs-20 number-font">${{ number_format((float)$user_data_year['total_payments'][0]['data'], 2, '.', '') }}</h3>
								</div>
							</div>
