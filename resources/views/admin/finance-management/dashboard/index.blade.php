				...
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							...
							<h2 class="mb-0"><span class="number-font fs-20">${{ number_format((float)$total_data_monthly['income_current_month'][0]['data'], 2, '.', '') }}</span><span class="ml-2 text-muted fs-11 data-percentage-change"><span class="fs-12" id="income_difference"></span> {{ __('this month') }}</span></h2>
						</div>
				...
				<div class="card-body">
					<div class="row mb-5 mt-2">	
						<div class="col-xl-3 col-12 ">
							...
							<h3 class="mb-0 fs-20 number-font">${{ number_format((float)$total_data_yearly['total_income'][0]['data'], 2, '.', '') }}</h3>
						</div>
						<div class="col-xl-3 col-12 ">
			...
			new Chart(ctx, {
				...
				data: {
					...
					datasets: [{
						...
						label: 'Total Estimated Spending ($) ',
