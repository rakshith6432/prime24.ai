		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					...
					<h2 class="mb-0"><span class="number-font-chars">${{ number_format(auth()->user()->balance) }}</span></h2>									
				</div>
			</div>
		</div>
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
				...
				<div class="card-body">
					<div class="row mb-5 mt-2">	
						<div class="col-xl-3 col-12 ">
							...
							<h3 class="mb-0 fs-20 number-font">${{ number_format((float)$total_data['total_payment'][0]['data'], 2, '.', '') }}</h3>
						</div>
					</div>
					<div class="row">
