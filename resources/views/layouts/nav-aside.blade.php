        ...
        @role('admin')
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('#')}}">
                    ...
                    <span class="side-menu__label">{{ __('Finance Management') }}</span><i class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('admin.finance.prepaid') }}" class="slide-item">{{ __('Pre Paid Plans') }}</a></li>
